package com.greed.section04.comparison_operator;
...
public class Application1 {
	...
	public static void main(String[] args) {
		 ...
		 * 삼항 연산자의 조건 식이나 조건문의 조건절에 많이 사용된다.
		 * 
		 *  */
...
//		System.out.println("bool1과 bool2가 큰지 비교 :" + (bool1 > bool2));
		...
		/* 문자열도 ==와 !=비교는 가능하지만 대소비교는 불가능하다
		 * 문자열은 특별하여 == 비교를 하지않지만 ==, !=가 가능하다는 것만 확인하자
		 * */
