package com.greedy.section02.package_and_import; // 첫줄은 패키지 

public class Application1 {
	
	public static void main(String[] args) {
		// import가 없다면... 다른 패키지에 있는 클래스를 사용하기 위해선 아래방법으로 적어야한다.
		 ...
		 *          클래스 명은 원래 패키지명을 포함하고 있음.
		 *          예) com.greedy.section01.method.Calculator
		 *          
		 *          지금까지 클래스명에 패키지명을 함께 사용하지 않은 이유는 동일한 패키지 내에서 사용했기 때문이다
		 *          그렇기 때문에 서로다른 패키지에 존재하는 클래스를 사용하는 경우에는
		 *          클래스명 앞에 패키지 명을 명시해서 풀 클래스 이름으로 사용해야한다.
		 * 
		 * */
